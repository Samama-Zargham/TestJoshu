export const contentTpes: any = {
    ...
    'Sports': [
        { label: "Soorts medicine", value: "Soorts medicine" },
        { label: "Team sociolody", value: "Team sociolody" },
        { label: "Olmoic economics", value: "Olmoic economics" }
    ],
